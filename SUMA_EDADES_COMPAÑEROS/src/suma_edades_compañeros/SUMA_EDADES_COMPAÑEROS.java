package suma_edades_compañeros; /** @author GUSTAVO CASTILLO */
public class SUMA_EDADES_COMPAÑEROS {
    public static void main(String[] args) {
         //Arreglo de nombres    
    String[] nombre = {"GREGORIO", "Darlin", "ESTEFANIA", "JORGE", "LUIS"};
    //Cambio de nombres
    nombre[0] = "CECILIA"; nombre[2] = "EDUARDO"; nombre[4] = "VICTORIA";
    //Arreglo de edades 
    int[] edad; edad = new int[5]; edad[0] = 20; edad[1] = 21; edad[2] = 22; edad[3] = 23; edad[4] = 24;
    //Cambio de edades
    edad[0] = 22; edad[2] = 19; edad[4] = 20;
